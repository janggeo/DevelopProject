...
public class DataDAO  {
    ...
    public MongoCollection<Document> coll3;
    int i=0;
...
//       }
        ...
        this.coll3 = mongoClient.getDatabase("VeganData").getCollection("restaurant");
        Log.info("info Log");
    }
...
//    }
    ...
    public List<Map> getMap(String search){
        FindIterable<Document> iterable = coll3.find();
        MongoCursor<Document> cursor = null;
        List<Map> list = new ArrayList<Map>();
        try{
            cursor = iterable.iterator();}
